...
public:
	...
	//-- Consructor.
	UIAnimation(UIObject* object, float timeLast, bool isLoop, AnimationStopEnum stopAt);
	//-- Destructor.
	~UIAnimation();
...
public:
	UITransAnimation(UIObject* object, int oriX, int oriY, int destX, int destY, float timeLast, bool isLoop, AnimationStopEnum stopAt);
...
public:
	UIWaitAnimation(UIObject* object, float timeLast);
};
...
public:
	UIScaleAnimation(UIObject* object, float oriX, float oriY, float destX, float destY, float timeLast, bool isLoop, AnimationStopEnum stopAt);
};
...
public:
	UIAlphaAnimation(UIObject* object, float oriAlpha, float destAlpha, float timeLast, bool isLoop, AnimationStopEnum stopAt);
};
