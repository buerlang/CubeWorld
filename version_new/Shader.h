...
public:
	...
	Shader* setBegin(function<void()> onBegin)
	{
		this->onBegin = onBegin;
		return this;
	}
	Shader* setEnd(function<void()> onEnd)
	{
		this->onEnd = onEnd;
		return this;
	}
	...
	Shader* registerUniform(char* name)
	{
		uniformMap.insert(pair<string, unsigned int>(name, glGetUniformLocation(Program, name)));
		return this;
	}
};
